...
package_application() {
    ...
    # on macOS is actively destructive: build:native rebuilds native addons
    # and overwrites the codesigned versions produced by sign-macos-binaries.sh,
    # so notarization sees unsigned nested binaries and rejects the bundle.
    #
